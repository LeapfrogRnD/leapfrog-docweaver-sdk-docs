...
from leapx.services.schema_generator.builders import ConstraintBuilder
from leapx.services.schema_generator.exceptions import JsonSchemaTypeError
from leapx.services.schema_generator.handlers import CombinerHandler
from leapx.services.schema_generator.interfaces import IModelBuilder
from leapx.services.schema_generator.resolvers import ReferenceResolver, TypeResolver
    ...
    def _create_array_root_model(
        ...
        if not items_schema:
            if allow_undefined_array_items:
                ...
                raise JsonSchemaTypeError("Array type must specify 'items' schema")
        else:
